...
func (*GraphSchema) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*Empty) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
type ComputeClient interface {
	Project(ctx context.Context, in *GraphQuery, opts ...grpc.CallOption) (*GraphID, error)
	Compute(ctx context.Context, in *GraphQuery, opts ...grpc.CallOption) (*EditResult, error)
}
...
func (c *computeClient) Project(ctx context.Context, in *GraphQuery, opts ...grpc.CallOption) (*GraphID, error) {
	out := new(GraphID)
	err := grpc.Invoke(ctx, "/gripql.Compute/Project", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *computeClient) Compute(ctx context.Context, in *GraphQuery, opts ...grpc.CallOption) (*EditResult, error) {
	out := new(EditResult)
	err := grpc.Invoke(ctx, "/gripql.Compute/Compute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ComputeServer interface {
	Project(context.Context, *GraphQuery) (*GraphID, error)
	Compute(context.Context, *GraphQuery) (*EditResult, error)
}
...
func _Compute_Project_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GraphQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ComputeServer).Project(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gripql.Compute/Project",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComputeServer).Project(ctx, req.(*GraphQuery))
	}
	return interceptor(ctx, in, info, handler)
}

func _Compute_Compute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GraphQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gripql.Compute/Compute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComputeServer).Compute(ctx, req.(*GraphQuery))
	}
	return interceptor(ctx, in, info, handler)
}

var _Compute_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gripql.Compute",
	HandlerType: (*ComputeServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Project",
			Handler:    _Compute_Project_Handler,
		},
		{
			MethodName: "Compute",
			Handler:    _Compute_Compute_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gripql.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
