...
var file_gripql_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x1c, 0x0a, 0x0a, 0x45, 0x64, 0x69, 0x74, 0x52, 0x65, 0x73,
	...
	0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x4f, 0x4f, 0x4c, 0x10, 0x03, 0x32, 0xb9, 0x05, 0x0a,
	...
	0x6d, 0x61, 0x12, 0x4a, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x72, 0x61, 0x70, 0x68, 0x73,
	...
	0x68, 0x7d, 0x2f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x32, 0xfa, 0x06, 0x0a, 0x04, 0x45, 0x64, 0x69,
...
var file_gripql_proto_depIdxs = []int32{
	...
	35, // 12: gripql.GraphStatement.in_opt:type_name -> google.protobuf.ListValue
	35, // 13: gripql.GraphStatement.out_opt:type_name -> google.protobuf.ListValue
	35, // 14: gripql.GraphStatement.both_opt:type_name -> google.protobuf.ListValue
	35, // 15: gripql.GraphStatement.in_e_opt:type_name -> google.protobuf.ListValue
	35, // 16: gripql.GraphStatement.out_e_opt:type_name -> google.protobuf.ListValue
	35, // 17: gripql.GraphStatement.both_e_opt:type_name -> google.protobuf.ListValue
	17, // 18: gripql.GraphStatement.select:type_name -> gripql.SelectStatement
	6,  // 19: gripql.GraphStatement.range:type_name -> gripql.Range
	15, // 20: gripql.GraphStatement.has:type_name -> gripql.HasExpression
	35, // 21: gripql.GraphStatement.has_label:type_name -> google.protobuf.ListValue
	35, // 22: gripql.GraphStatement.has_key:type_name -> google.protobuf.ListValue
	35, // 23: gripql.GraphStatement.has_id:type_name -> google.protobuf.ListValue
	35, // 24: gripql.GraphStatement.distinct:type_name -> google.protobuf.ListValue
	35, // 25: gripql.GraphStatement.fields:type_name -> google.protobuf.ListValue
	8,  // 26: gripql.GraphStatement.aggregate:type_name -> gripql.Aggregations
	36, // 27: gripql.GraphStatement.render:type_name -> google.protobuf.Value
	35, // 28: gripql.GraphStatement.path:type_name -> google.protobuf.ListValue
	9,  // 29: gripql.AggregationsRequest.aggregations:type_name -> gripql.Aggregate
	9,  // 30: gripql.Aggregations.aggregations:type_name -> gripql.Aggregate
	10, // 31: gripql.Aggregate.term:type_name -> gripql.TermAggregation
	11, // 32: gripql.Aggregate.percentile:type_name -> gripql.PercentileAggregation
	12, // 33: gripql.Aggregate.histogram:type_name -> gripql.HistogramAggregation
	36, // 34: gripql.NamedAggregationResult.key:type_name -> google.protobuf.Value
	15, // 35: gripql.HasExpressionList.expressions:type_name -> gripql.HasExpression
	14, // 36: gripql.HasExpression.and:type_name -> gripql.HasExpressionList
	14, // 37: gripql.HasExpression.or:type_name -> gripql.HasExpressionList
	15, // 38: gripql.HasExpression.not:type_name -> gripql.HasExpression
	16, // 39: gripql.HasExpression.condition:type_name -> gripql.HasCondition
	36, // 40: gripql.HasCondition.value:type_name -> google.protobuf.Value
	0,  // 41: gripql.HasCondition.condition:type_name -> gripql.Condition
	20, // 42: gripql.Selection.vertex:type_name -> gripql.Vertex
	21, // 43: gripql.Selection.edge:type_name -> gripql.Edge
	34, // 44: gripql.Selections.selections:type_name -> gripql.Selections.SelectionsEntry
	37, // 45: gripql.Vertex.data:type_name -> google.protobuf.Struct
	37, // 46: gripql.Edge.data:type_name -> google.protobuf.Struct
	20, // 47: gripql.QueryResult.vertex:type_name -> gripql.Vertex
	21, // 48: gripql.QueryResult.edge:type_name -> gripql.Edge
	13, // 49: gripql.QueryResult.aggregations:type_name -> gripql.NamedAggregationResult
	19, // 50: gripql.QueryResult.selections:type_name -> gripql.Selections
	36, // 51: gripql.QueryResult.render:type_name -> google.protobuf.Value
	35, // 52: gripql.QueryResult.path:type_name -> google.protobuf.ListValue
	20, // 53: gripql.GraphElement.vertex:type_name -> gripql.Vertex
	21, // 54: gripql.GraphElement.edge:type_name -> gripql.Edge
	28, // 55: gripql.ListIndicesResponse.indices:type_name -> gripql.IndexID
	18, // 56: gripql.Selections.SelectionsEntry.value:type_name -> gripql.Selection
	3,  // 57: gripql.Query.Traversal:input_type -> gripql.GraphQuery
	27, // 58: gripql.Query.GetVertex:input_type -> gripql.ElementID
	27, // 59: gripql.Query.GetEdge:input_type -> gripql.ElementID
	26, // 60: gripql.Query.GetTimestamp:input_type -> gripql.GraphID
	26, // 61: gripql.Query.GetSchema:input_type -> gripql.GraphID
	30, // 62: gripql.Query.ListGraphs:input_type -> gripql.Empty
	26, // 63: gripql.Query.ListIndices:input_type -> gripql.GraphID
	26, // 64: gripql.Query.ListLabels:input_type -> gripql.GraphID
	25, // 65: gripql.Edit.AddVertex:input_type -> gripql.GraphElement
	25, // 66: gripql.Edit.AddEdge:input_type -> gripql.GraphElement
	25, // 67: gripql.Edit.BulkAdd:input_type -> gripql.GraphElement
	26, // 68: gripql.Edit.AddGraph:input_type -> gripql.GraphID
	26, // 69: gripql.Edit.DeleteGraph:input_type -> gripql.GraphID
	27, // 70: gripql.Edit.DeleteVertex:input_type -> gripql.ElementID
	27, // 71: gripql.Edit.DeleteEdge:input_type -> gripql.ElementID
	28, // 72: gripql.Edit.AddIndex:input_type -> gripql.IndexID
	28, // 73: gripql.Edit.DeleteIndex:input_type -> gripql.IndexID
	2,  // 74: gripql.Edit.AddSchema:input_type -> gripql.Graph
	22, // 75: gripql.Query.Traversal:output_type -> gripql.QueryResult
	20, // 76: gripql.Query.GetVertex:output_type -> gripql.Vertex
	21, // 77: gripql.Query.GetEdge:output_type -> gripql.Edge
	29, // 78: gripql.Query.GetTimestamp:output_type -> gripql.Timestamp
	2,  // 79: gripql.Query.GetSchema:output_type -> gripql.Graph
	31, // 80: gripql.Query.ListGraphs:output_type -> gripql.ListGraphsResponse
	32, // 81: gripql.Query.ListIndices:output_type -> gripql.ListIndicesResponse
	33, // 82: gripql.Query.ListLabels:output_type -> gripql.ListLabelsResponse
	23, // 83: gripql.Edit.AddVertex:output_type -> gripql.EditResult
	23, // 84: gripql.Edit.AddEdge:output_type -> gripql.EditResult
	24, // 85: gripql.Edit.BulkAdd:output_type -> gripql.BulkEditResult
	23, // 86: gripql.Edit.AddGraph:output_type -> gripql.EditResult
	23, // 87: gripql.Edit.DeleteGraph:output_type -> gripql.EditResult
	23, // 88: gripql.Edit.DeleteVertex:output_type -> gripql.EditResult
	23, // 89: gripql.Edit.DeleteEdge:output_type -> gripql.EditResult
	23, // 90: gripql.Edit.AddIndex:output_type -> gripql.EditResult
	23, // 91: gripql.Edit.DeleteIndex:output_type -> gripql.EditResult
	23, // 92: gripql.Edit.AddSchema:output_type -> gripql.EditResult
